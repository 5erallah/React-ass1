...
import { FaFacebookF, FaGlobe,FaTwitter,FaYoutube } from "react-icons/fa";
    ...
    <div className=' bg-[#2c3e50] p-4 '>
        <div className='max-w-5xl mx-auto flex flex-col space-y-20 md:space-y-0 md:flex-row text-white items-center justify-between py-12'>
          ...
          <div className=' space-y-4'>
            ...
            <p className='text-center '>Freelance is a free to use, licensed Bootstrap theme<br/> Bootstrap theme created by Route(BENZO)  </p>
          </div>
